...
#define UFS_PHY_SYSCLK_EN_COUNT_CTRL 		PHY_OFF(0x1E4)
...
#define QSERDES_RX0_RX_MODE_RATE4_B4		RX_OFF(0, 0x284)
#define QSERDES_RX0_DLL_COARSE_TUNE_POST_CAL_OFFSET	RX_OFF(0, 0x2EC)
#define QSERDES_RX0_UCDR_SO_GAIN_RATE4		RX_OFF(0, 0xF0)
#define QSERDES_RX0_DLL_COARSE_TUNE_CTRL	RX_OFF(0, 0x2E8)
#define QSERDES_RX0_DLL_CTRL1			RX_OFF(0, 0x2E0)
#define QSERDES_RX0_UCDR_PI_CONTROLS		RX_OFF(0, 0xF4)
...
#define QSERDES_RX1_RX_MODE_RATE4_B4		RX_OFF(1, 0x284)
#define QSERDES_RX1_DLL_COARSE_TUNE_POST_CAL_OFFSET	RX_OFF(1, 0x2EC)
#define QSERDES_RX1_UCDR_SO_GAIN_RATE4		RX_OFF(1, 0xF0)
#define QSERDES_RX1_DLL_COARSE_TUNE_CTRL	RX_OFF(1, 0x2E8)
#define QSERDES_RX1_DLL_CTRL1			RX_OFF(1, 0x2E0)
#define QSERDES_RX1_UCDR_PI_CONTROLS		RX_OFF(1, 0xF4)
...
static struct ufs_qcom_phy_calibration phy_cal_table_rate_A_g5[] = {
	UFS_QCOM_PHY_CAL_ENTRY(UFS_PHY_SYSCLK_EN_COUNT_CTRL, 0x7F),
	...
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_COM_LOCK_CMP_EN, 0x41),
	...
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_COM_LOCK_CMP2_MODE0, 0x13),
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_COM_LOCK_CMP1_MODE1, 0xCC),
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_COM_LOCK_CMP2_MODE1, 0x16),
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_COM_CMN_IETRIM,0x1B),
